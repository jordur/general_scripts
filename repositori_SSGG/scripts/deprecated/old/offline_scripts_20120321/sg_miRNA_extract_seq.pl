...
sub usage {
    print "\nCOMO SE USA:\n";
    print "sg_miRNA_extract_seq.pl 1 2 .\n";
    print "1) Archivo con los miRNAs ordenados por posicion y separados por cromosomas ej: nombre_miRNA<TAB>start<TAB>end<TAB>strand.\n";
