...
#	$4 : output directory sufix (ending with /)
{
	...
	samtools view -b -q 10 $1$2/$3F3-F5-BC-Paired.bam > $1$2/$3PE_Q10.bam
	...
	/share/apps/samtools-0.1.9/samtools pileup -cf /data/results/Solid0065/referencia_genoma_humano/GRch37.58/hg19.fa $1$2/$3PE_Q10.bam > $1$2/$3$4PE_Q10.pileup
	...
	for j in ${i[@]}; do
        	awk '{if ($1=="chr'${j}'") print $0}' $1$2/$3$4PE_Q10.pileup > $1$2/$3$4chr$j.pileup
	done
