...
#La primera variable debe ser old o new para elegir el diseño de Junior
...
do
	...
	do
		...
		sg_obtencion_bases_en_rango.pl /share/apps/scripts/resecuenciacion_dirigida/Junior/$design\_design_chr$i.bed $sample\_bases_$i > $sample\_bases_N_rango_$i
		...
		#------------->  Cambiar intervalos de captura
		/share/apps/scripts/resecuenciacion_dirigida/deleciones-duplicaciones/sg_convertir_intervalo_N_columna_posiciones.pl /share/apps/scripts/resecuenciacion_dirigida/Junior/$design\_design_chr$i.bed | sort -u -n >  posiciones_$i
