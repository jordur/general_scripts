...
realignment () 
{
	...
	java -Djava.io.tmpdir=/scratch/ -jar /share/apps/GenomeAnalysisTK-1.0.5777/GenomeAnalysisTK.jar -T UnifiedGenotyper -R  $reference -nt 4 -I $1\_sorted_Q1.bam  -o $1\_allbases.vcf_raw --output_mode EMIT_ALL_SITES
