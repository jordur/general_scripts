...
while ( $line_qual=<qual_file> ) {
	...
	if ( substr($qual_values[0],0,1) ne ">" ) {
		...
		if ( (($#qual_values+1) != $csfasta_reads) || (($#base_values-1) != $csfasta_reads ) ) {
			...
			my $seqs_mean=$seqs_quals_mean / $seq_bases_read;
			if ($seqs_mean < 1) {
				$per_seq_QVs[0]++;
			} elsif ($seqs_mean < 2) {
				$per_seq_QVs[1]++;
...
for ($i=0;$i<$csfasta_reads;$i++) {	
	...
	$line_file=$i."\t".$position_quals_mean_all[$i]."\t".$position_bases_read[$i]."\t".$position_quals_mean[$i]."\t".$position_quals_max[$i]."\t".$position_quals_min[$i]."\t".$position_quals_median[$i]."\t".$position_quals_0_mean[$i]."\t".$position_quals_1_mean[$i]."\t".$position_quals_2_mean[$i]."\t".$position_quals_3_mean[$i]."\t".$position_quals_0_count[$i]/$position_bases_read[$i]*100 . "\t".$position_quals_1_count[$i]/$position_bases_read[$i]*100 . "\t".$position_quals_2_count[$i]/$position_bases_read[$i]*100 . "\t".$position_quals_3_count[$i]/$position_bases_read[$i]*100 . "\t".$position_quals_percent20[$i]."\t".$position_quals_percent80[$i]."\n";
