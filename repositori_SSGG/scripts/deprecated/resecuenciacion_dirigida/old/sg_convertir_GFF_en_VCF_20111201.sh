...
do
	...
	/usr/local/bin/scripts/sg_extract_seq.pl $j\_GFF_VCF_coords_tmp2 /data/results/Solid0065/referencia_genoma_humano/GRch37.58/chr$j | grep -v ">" > $j\_GFF_VCF_bases_tmp3
