...
sub usage
{
    ...
    print "       2) fichero tabulado de SNPs en el que la primera columna es el cromosoma, la segunda posición, la tercera la base referencia; la cuarta, la base encontrada; la quinta, la calidad del consenso; la sexta, calidad del SNP; la séptima la calidad máxima de mapeo; y la octava, el coverage\nejemplo: chr1    85      T       G	28      33      34      3\n";
