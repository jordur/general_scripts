...
open (FILE1, "<", @ARGV[0]);
open (CHR1, ">", 'CHR1.ma.fasta') or die "No puedo abrir CHR1.ma.fasta.\n";
open (CHR2, ">", 'CHR2.ma.fasta') or die "No puedo abrir CHR2.ma.fasta.\n";
open (CHR3, ">", 'CHR3.ma.fasta') or die "No puedo abrir CHR3.ma.fasta.\n";
open (CHR4, ">", 'CHR4.ma.fasta') or die "No puedo abrir CHR4.ma.fasta.\n";
open (CHR5, ">", 'CHR5.ma.fasta') or die "No puedo abrir CHR5.ma.fasta.\n";
open (CHR6, ">", 'CHR6.ma.fasta') or die "No puedo abrir CHR6.ma.fasta.\n";
