...
# @Desc: Script to map Illumina data with Novoalign
# @Author: JM Rosa
# @Contributors: Arbol
###############################################
...
print "\n=================================================================
$basename: Script to map Illumina data with Novoalign v1.0\n";
...
sub main (){
	...
	my $aln_id = mapping_novoalign->mapping_essay ($essay, $cwd);
	print "JOB_ID\t$aln_id\n";
}
