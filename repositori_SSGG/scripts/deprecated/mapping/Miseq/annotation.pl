...
# @Desc: Script to annotate variants
# @Author: JM Rosa
# @Contributors: Arbol
###############################################
...
print "\n=================================================================
$basename: Script to annotate and filter variants v1.0\n";
...
sub main (){
	...
	my $anno_id = annotation->annotate ($essay, $cwd, $hold_jid);
	print "JOB_ID\t$anno_id\n";
