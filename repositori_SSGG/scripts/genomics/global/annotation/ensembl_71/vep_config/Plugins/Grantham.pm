...
sub get_header_info {
    ...
    return {
        ...
        Grantham_distance => "Grantham Matrix score - Grantham, R. Amino Acid Difference Formula to Help Explain Protein Evolution, Science 1974 Sep 6;185(4154):862-4.",
